...
import { Users, Plus, Edit, Trash2, Power, Search, Shield, UserCheck, UserX, Mail, Menu, X, Monitor, Video, Camera, AlertTriangle, BarChart3, Upload, LogOut, Clock } from 'lucide-react';
          ...
          <div className="mb-6">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-3 sm:p-4">
              <nav className="flex flex-col sm:flex-row sm:flex-wrap gap-2 text-sm text-gray-700">
                ...
                <a href="/admin/users" className="flex items-center px-3 py-2 rounded-xl hover:bg-gray-50 bg-blue-50">
