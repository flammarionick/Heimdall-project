...
import { Search, Filter, User, MapPin, Calendar, AlertTriangle, Plus, Eye, Edit, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-gray-800 mb-2">Inmate Profiles</h1>
