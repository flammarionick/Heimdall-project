...
import { AlertTriangle, CheckCircle, Clock, User, Camera, Filter, Search, Download, Eye } from 'lucide-react';
...
export default function AlertsLogs() {
  const [alerts, setAlerts] = useState([
    ...
    {
      id: 4,
      timestamp: new Date('2024-12-01T23:20:00'),
      message: 'Escaped convict identified at Cafeteria',
      level: 'critical',
      inmate_id: 'INM-8765',
      inmate_name: 'Robert Brown',
      camera: 'Cafeteria Monitor',
      resolved: true
    },
    {
      id: 5,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-gray-800 mb-2">Alerts & Logs</h1>
              <p className="text-gray-600 flex items-center">
                <Clock className="w-4 h-4 mr-2" />
                Security event monitoring and management
              </p>
            </div>
            <button className="flex items-center px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-200">
                  ...
                  <div className="flex gap-2 ml-4">
                    ...
                    {!alert.resolved && (
                      <button
                        ...
                        className="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-all font-medium text-sm"
                      >
                        Resolve
                      </button>
                    )}
